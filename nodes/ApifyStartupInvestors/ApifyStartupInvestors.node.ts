...
import { properties } from './ApifyStartupInvestors.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'SVdYzqKOwfJT7shHd' as string;

export const PACKAGE_NAME = 'n8n-nodes-startup-investors-api' as string;
export const CLASS_NAME = 'ApifyStartupInvestors' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'startup-investors-app' as string;

export const DISPLAY_NAME = 'Startup Investors' as string;
export const DESCRIPTION =
	'Search a database of startup investors and return firm names, websites, focus areas, and stages' as string;

export class ApifyStartupInvestors implements INodeType {
